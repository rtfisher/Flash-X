#----------------------------------------------------------------------------
# FLASH makefile definitions for Sedona (x86-64 Ubuntu)
#----------------------------------------------------------------------------
...
#----------------------------------------------------------------------------
ifeq      ($(NDIM), 1)
AMREX_PATH = /home/lib/amrex/1D
else ifeq ($(NDIM), 2)
AMREX_PATH = /home/lib/amrex/2D
else ifeq ($(NDIM), 3)
AMREX_PATH = /home/lib/amrex/3D
else
AMREX_PATH =
endif
...
#----------------------------------------------------------------------------
FFLAGS_OPT   = -c -O2 -fdefault-real-8 -fdefault-double-8 -Wuninitialized -DHAVE_MPI_MODULE
...
FFLAGS_DEBUG = -ggdb -c -O0 -fdefault-real-8 -fdefault-double-8 \
	       ...
	       -fbacktrace -fbounds-check -DHAVE_MPI_MODULE

FFLAGS_TEST  = -ggdb -c -fdefault-real-8 -fdefault-double-8 \
	       -ffree-line-length-none -DHAVE_MPI_MODULE
