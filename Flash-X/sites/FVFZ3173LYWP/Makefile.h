...
#----------------------------------------------------------------------------
#HDF4_PATH =
#HDF5_PATH = /usr/local/hdf5-1.8.16
HDF5_PATH = /usr/local/opt/hdf5@1.12
...
CFLAGS_OPT = -ggdb -c -O2 -Wuninitialized -D_FORTIFY_SOURCE=2 -Wno-error=implicit-function-declaration
